...
/** @def CXXD_SYSTEM_USE_BOOST
    @brief Override macro for Boost system implementation.
    
    The object-like macro, when defined to nothing prior to including this header file, 
    forces the dual library choice of the Boost system implementation.
*/

/** @def CXXD_SYSTEM_USE_STD
    @brief Override macro for C++ standard system implementation.
    
    The object-like macro, when defined to nothing prior to including this header file,
    forces the dual library choice of the C++ standard system implementation. If the
    C++ standard system implementation is not available a preprocessor error is generated.
*/
...
*/
        ...
        #if (!defined(CXXD_NO_CONFIG) && defined(BOOST_NO_CXX11_HDR_SYSTEM_ERROR)) || defined(CXXD_SYSTEM_USE_BOOST) || defined(CXXD_USE_BOOST)
