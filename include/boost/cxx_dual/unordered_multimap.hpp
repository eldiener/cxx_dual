...
/** @file unordered_multimap.hpp
    @brief Dual library for the unordered_multimap implementation.
...
/** @def CXXD_UNORDERED_MULTIMAP_NS
    ...
    The object-like macro expands to the namespace for the unordered_multimap implementation.
*/

/** @def CXXD_UNORDERED_MULTIMAP_USE_BOOST
    @brief Override macro for Boost unordered_multimap implementation.
    
    The object-like macro, when defined to nothing prior to including this header file, 
    forces the dual library choice of the Boost unordered_multimap implementation.
*/

/** @def CXXD_UNORDERED_MULTIMAP_USE_STD
    @brief Override macro for C++ standard unordered_multimap implementation.
    
    The object-like macro, when defined to nothing prior to including this header file,
    forces the dual library choice of the C++ standard unordered_multimap implementation. If the
    C++ standard unordered_multimap implementation is not available a preprocessor error is generated.
*/

/** @def CXXD_HAS_STD_UNORDERED_MULTIMAP
    @brief Determines whether the C++ standard unordered_multimap implementation or the Boost unordered_multimap implementation has been chosen.
    
    The object-like macro expands to:
    1 if the C++ standard unordered_multimap implementation has been chosen
    0 if the Boost unordered_multimap implementation has been chosen.
*/
		...
		#error CXXD: Using C++ standard and using Boost are both defined for unordered_multimap
            ...
            #define CXXD_UNORDERED_MULTIMAP_ERROR
            #error CXXD: Previous use of C++ standard unordered_multimap erroneously overridden
        #elif !CXXD_HAS_STD_UNORDERED_MULTIMAP && (defined(CXXD_UNORDERED_MULTIMAP_USE_STD) || defined(CXXD_USE_STD))
            #define CXXD_UNORDERED_MULTIMAP_ERROR
            #error CXXD: Previous use of Boost unordered_multimap erroneously overridden
        #endif
        ...
        #include <boost/config.hpp>
                ...
                #define CXXD_UNORDERED_MULTIMAP_ERROR
                #error CXXD: C++ standard unordered_multimap is not available
            #else
