...
/** @def CXXD_BIND_USE_BOOST
    @brief Override macro for Boost bind implementation.
    
    The object-like macro, when defined to nothing prior to including this header file, 
    forces the dual library choice of the Boost bind implementation.
*/

/** @def CXXD_BIND_USE_STD
    @brief Override macro for C++ standard bind implementation.
    
    The object-like macro, when defined to nothing prior to including this header file,
    forces the dual library choice of the C++ standard bind implementation. If the
    C++ standard bind implementation is not available a preprocessor error is generated.
*/
...
*/
	...
	#elif defined(CXXD_HAS_STD_BIND)
