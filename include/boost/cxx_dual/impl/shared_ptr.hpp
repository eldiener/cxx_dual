...
/** @def CXXD_SHARED_PTR_ALL_HEADER
    @brief The shared_ptr header file name for all shared_ptr header implementations.
    
    The object-like macro expands to the include header file designation for all shared_ptr header file implemntations.
    The macro is used with the syntax: \#include CXXD_SHARED_PTR_ALL_HEADER
...
*/
	...
	#elif defined(CXXD_HAS_STD_SHARED_PTR)
        ...
        #include <boost/config.hpp>
            ...
            #define CXXD_SHARED_PTR_ALL_HEADER <memory>
        #endif
    #endif
#endif
