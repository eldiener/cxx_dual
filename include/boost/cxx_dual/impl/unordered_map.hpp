...
/** @def CXXD_UNORDERED_MAP_USE_BOOST
    @brief Override macro for Boost unordered map implementation.
    
    The object-like macro, when defined to nothing prior to including this header file, 
    forces the dual library choice of the Boost unordered map implementation.
*/

/** @def CXXD_UNORDERED_MAP_USE_STD
    @brief Override macro for C++ standard unordered map implementation.
    
    The object-like macro, when defined to nothing prior to including this header file,
    forces the dual library choice of the C++ standard unordered map implementation. If the
    C++ standard unordered map implementation is not available a preprocessor error is generated.
*/
...
*/
	...
	#elif defined(CXXD_HAS_STD_UNORDERED_MAP)
